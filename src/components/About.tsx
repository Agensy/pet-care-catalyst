...
import aboutImage from "@/assets/woman-kitten-grass.jpg";
const About = () => {
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
            <div className="relative z-10">
              <img src={aboutImage} alt="Mulher cuidando carinhosamente de gatinho na grama" className="w-full rounded-2xl shadow-strong" />
            </div>
            {/* Decorative Elements */}
